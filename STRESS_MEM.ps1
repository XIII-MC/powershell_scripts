...
# RAM in box
$box= Get-WmiObject -Class WIN32_OperatingSystem
$Global:physMB=$box.TotalVisibleMemorySize / 1024

# Create object to get current memory available
$Global:psPerfMEM = $box.FreePhysicalMemory/1024

# leave 512Mb for the OS to survive.
$HEADROOM=512

$ram = $physMB - $psPerfMEM
